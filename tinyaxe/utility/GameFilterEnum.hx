...
class GameFilterEnum {
	...
	public static var selectGlowFilter:GlowFilter = new GlowFilter(0xffde00, 1, 4, 4, 6, 1);
	public static var yellowGlowFilter:GlowFilter = new GlowFilter(0xFFFF8A, 1, 4, 4);
	public static var EscortGlowFilter:GlowFilter = new GlowFilter(0xffea00, 1, 6, 6);
	...
	public static var orangeColorFilter:ColorMatrixFilter = new ColorMatrixFilter([1, 0, 0, 0, 170, 0, 1, 0, 0, 80, 0, 0, 1, 0, 0, 0, 0, 0, 1, 0]);// 橙
	public static var guildBattleBlueColorFilter:ColorMatrixFilter = new ColorMatrixFilter([0.4, 0, 0, 0, 0, 0, 0.4, 0, 0, 67, 0, 0, 0.4, 0, 180, 0, 0, 0, 1, 0]);// 蓝
}